...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 14 2021 г., 20:14
...
CREATE TABLE `table1` (
  ...
  `id` int(11) NOT NULL,
  `isNovelty` tinyint(1) DEFAULT NULL,
...
INSERT INTO `table1` (`n`, `id`, `isNovelty`, `Name`, `Price`, `Publishing_House`, `Pages`, `Format`, `Date`, `Circulation`, `Theme`, `Category`) VALUES
